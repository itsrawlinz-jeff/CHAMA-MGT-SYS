        ...
        <div class="container py-3">
            <div class="row ">
                <div class="col-md-7 comp-grid">
                        ...
                        <form class="form page-form form-horizontal needs-validation" action="../USERS/update.php" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Name <span class="text-danger" ></span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="update Name"  required="" name="name" value="<?php echo $_SESSION['name']?>" class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Password <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="password" placeholder="password" id="password" required="" name="password" value="<?php echo $_SESSION['password']?>"  class="form-control " />
