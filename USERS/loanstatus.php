...
<div id="main-content">
	<!-- Page Main Content Start -->
		<div id="page-content">
            ...
            <div class="container">
            <div class="form page-form form-horizontal needs-validation" >
                       <?php 
                       $conn = mysqli_connect('localhost', 'root', '', 'portal');
                       $query = mysqli_query($conn,"SELECT * FROM loan where applicant_name = '".$_SESSION['name']."'");
                       ?>
...
<table class="table table-striped">
  ...
  <tbody>
      ...
      <?php }}else{
          ?>
          <div class="alert alert-danger">You have no records of loan requests.</div>
    <?php
      }?>
  </tbody>
</table>
