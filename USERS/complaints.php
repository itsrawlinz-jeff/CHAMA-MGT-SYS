        ...
        <div class="container py-3">
            <div class="row ">
                <div class="col-md-7 comp-grid">
                        ...
                        <form class="form page-form form-horizontal needs-validation" action="../USERS/addcomplain.php" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="Enter Headline"  required="" name="headline"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Enter Message"  rows="5" name="message" class="htmleditor form-control"></textarea>
                                        ...
                                        <input id="ctrl-sender"  value="<?php echo $_SESSION['name']?>" type="hidden" placeholder="Enter Sender"  name="sender"  class="form-control " />
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
