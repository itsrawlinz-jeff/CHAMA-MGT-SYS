        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                                        <a class="animated rubberBand record-count card bg-success text-white"  href="../USERS/complaints.php">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                                        <a class="animated rotateInUpRight record-count alert alert-secondary"  href="../USERS/events.php">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                                        <a class="animated zoomIn record-count alert alert-primary"  href="../USERS/contributions.php">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                                        <a class="animated rubberBand record-count card bg-light text-dark"  href="../USERS/bankinfo.php">
                        <div class="row">
                            <div class="col-2">
