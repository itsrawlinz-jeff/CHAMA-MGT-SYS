        ...
        <div class="container py-3">
            <div class="row ">
                <div class="col-md-7 comp-grid">
                        ...
                        <form class="form page-form form-horizontal needs-validation" action="../USERS/addbankinfo.php" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Holder Name <span class="text-danger" ></span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="update Name"  required="" name="holder_name" value="<?php echo $_SESSION['name']?>" class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Bank Name <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="Bank Name"  required="" name="bank_name" class="form-control " />  
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Branch Name <span class="text-danger" ></span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="Branch Name"  required="" name="branch_name" class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Account Number <span class="text-danger" ></span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="number" placeholder="account no."  required="" name="account_no" class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="headline">Account Type <span class="text-danger" ></span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input type="text" placeholder="account type"  required="" name="account_type" class="form-control" value="group saving account" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
